...
let sampleListing = [
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1602088113235-229c19758e9f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8N3x8Y2FtcGluZ3xlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&w=800&q=60",
    price: 1100,
    location: "Cotswolds",
  ...
  },
  {
    title: "Desert Oasis",
    description:
      "Find tranquility in the desert with this luxurious oasis resort. Perfect for a serene and peaceful escape.",
    image:
      "https://a0.muscache.com/im/pictures/hosting/Hosting-U3RheVN1cHBseUxpc3Rpbmc6MTEyNjIzMTk3NDU3MjE4Nzg2NA%3D%3D/original/f4cbe542-3ce0-4c6f-a8f1-d2120c1b2420.jpeg?im_w=960&im_q=highq",
    price: 2000,
    location: "Dubai",
  ...
  },
  {
    ...
    description:
      "Live like royalty in this elegant countryside manor. Ideal for family gatherings and special occasions.",
    image:
      "https://a0.muscache.com/im/pictures/hosting/Hosting-U3RheVN1cHBseUxpc3Rpbmc6MTEyNTQ0NTEyMzEwMTI3NDg1MQ%3D%3D/original/bd73f0f8-9057-4bbc-ad70-1db13eb5c03f.png?im_w=960&im_q=highq",
    price: 5000,
    location: "Bordeaux",
    country: "France",
  },
...
sampleListing = sampleListing.map((listing, i) => ({
  ...listing,
  image: {
    url: listing.image,
    filename: `sampleListing${i+1}`
  },
  owner: "66aeee82fab8c10f84e58600"
}));
